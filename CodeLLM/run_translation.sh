...
python run_translation.py --input_file data/preprocessed_niche_test_sampled.json --output_file output/Qwen3-Coder-30B-A3B-Instruct_niche_sampled.json --vllm_path Qwen/Qwen3-Coder-30B-A3B-Instruct
python run_translation.py --input_file data/preprocessed_niche_test_sampled_base.json --output_file output/Qwen3-Coder-30B-A3B-Instruct_niche_sampled_base.json --vllm_path Qwen/Qwen3-Coder-30B-A3B-Instruct