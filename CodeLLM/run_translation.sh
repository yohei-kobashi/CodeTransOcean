...
python run_translation.py --input_file data/preprocessed_LLMTrans_test.json --output_file output/Qwen3-Coder-30B-A3B-Instruct_LLMTrans.json --vllm_path Qwen/Qwen3-Coder-30B-A3B-Instruct
python run_translation.py --input_file data/preprocessed_LLMTrans_test_base.json --output_file output/Qwen3-Coder-30B-A3B-Instruct_LLMTrans_base.json --vllm_path Qwen/Qwen3-Coder-30B-A3B-Instruct
