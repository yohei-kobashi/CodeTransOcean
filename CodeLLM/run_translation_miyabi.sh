...
# python run_translation.py --input_file data/preprocessed_niche_test_sampled.json --output_file output/Qwen3-Coder-30B-A3B-Instruct_0826_niche_sampled.json --vllm_path /work/go25/share/model/Qwen3-Coder-30B-A3B-Instruct-mcore-hf_code_trans_489pairs_0826
# python run_translation.py --input_file data/preprocessed_niche_test_sampled_base.json --output_file output/Qwen3-Coder-30B-A3B-Instruct_0826_niche_sampled_base.json --vllm_path /work/go25/share/model/Qwen3-Coder-30B-A3B-Instruct-mcore-hf_code_trans_489pairs_0826